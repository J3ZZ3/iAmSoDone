import { Button, TextInput, View, StyleSheet, ImageBackground, Pressable, Text } from 'react-native';
    ...
    <View style={styles.container}>
      ...
      {!pendingVerification && (
        <>
          ...
          <TextInput placeholder="Enter Password" value={password} onChangeText={setPassword} secureTextEntry style={styles.inputField} />

          <Button onPress={onSignUpPress} title="Sign up" color={'#FF3F3F'}></Button>
        </>
      )}
