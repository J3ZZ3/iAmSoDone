...
export function useRecordings() {
  ...
  async function uploadRecording(recording) {
    try {
      ...
      const fileExtension = fileUri.split('.').pop(); // Get file extension (e.g., 'm4a')
      ...
      const { data, error } = await supabase
        .storage
        .from('audio-recordings')  // Replace with your bucket name
  ...
  return {
    ...
    deleteRecording,
    renameRecording,
    uploadRecording, // Export the upload function
  };
}
